package com.ibase.web.workparam_in.domain;
 ...
 * 本地工参
 */
public class WorkParam_inDomain extends BaseDomain {
	private long wp_id;
	...
	private String wp_cell_section;
	private String wp_cell_ECI;
	private String wp_cell_PCI;
	private String wp_cell_workModel;
	...
	private int status;
	private long wp_modifier;
	private String wp_update_time;
	...
	public String getWp_update_time() {
		return wp_update_time;
	}
	public void setWp_update_time(String wp_update_time) {
		this.wp_update_time = wp_update_time;
	}
	...
	public long getWp_modifier() {
		return wp_modifier;
	}
	public void setWp_modifier(long wp_modifier) {
		this.wp_modifier = wp_modifier;
	}
	...
	public String toString() {
		return "WorkParam_inDomain [wp_id=" + wp_id + ", wp_station_no=" + wp_station_no + ", wp_station_height="
				+ wp_station_height + ", wp_station_longitude=" + wp_station_longitude + ", wp_station_latitude="
				+ wp_station_latitude + ", wp_station_TAC=" + wp_station_TAC + ", wp_station_ENBID=" + wp_station_ENBID
				+ ", wp_cell_section=" + wp_cell_section + ", wp_cell_ECI=" + wp_cell_ECI + ", wp_cell_PCI="
				+ wp_cell_PCI + ", wp_cell_workModel=" + wp_cell_workModel + ", wp_cell_bearing=" + wp_cell_bearing
				+ ", wp_cell_dipAangle=" + wp_cell_dipAangle + ", wp_cell_top_frequency=" + wp_cell_top_frequency
				+ ", wp_cell_top_bandwidth=" + wp_cell_top_bandwidth + ", wp_cell_down_frequency="
				+ wp_cell_down_frequency + ", wp_cell_down_bandwidth=" + wp_cell_down_bandwidth + ", status=" + status
				+ ", wp_modifier=" + wp_modifier + ", wp_update_time=" + wp_update_time + "]";
	}
