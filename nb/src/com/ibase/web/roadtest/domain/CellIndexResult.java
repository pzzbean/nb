...
public class CellIndexResult {
	...
	public CellIndexResult(int userId, String testDate, String station_No, String communityName, String wireless_RSRP,
			String wireless_SINR, int a_Attempts, int a_Success, String a_SuccessRatio, int c_ReElection, int c_Success,
			String c_ReElectionRatio, String p_Delay, int p_Pttempts, int p_success, String p_SuccessRadio,
			String udp_UpRate, String udp_DownRate, String cellId, String pci, String frequency, String r_ReElection,
			String r_Success, String r_ReElectionRatio, String tac, String ci) {
		super();
		this.userId = userId;
	...
	public CellIndexResult() {
		super();
	}
	
	@Override
	public String toString() {
		return "CellIndexResult [userId=" + userId + ", testDate=" + testDate + ", station_No=" + station_No
				+ ", communityName=" + communityName + ", wireless_RSRP=" + wireless_RSRP + ", wireless_SINR="
				+ wireless_SINR + ", a_Attempts=" + a_Attempts + ", a_Success=" + a_Success + ", a_SuccessRatio="
				+ a_SuccessRatio + ", c_ReElection=" + c_ReElection + ", c_Success=" + c_Success
