...
public class StringUtil {
     ...
     * @param str
     * @param nullable 数据库不允许为null，value为nul时返回""
     * @param maxLength 最大长度。
     * @return
     */
    public static String dbSafeString(String str, boolean nullable, int maxLength) {
        if (str == null) {
            if (nullable)
                return null;
    ...
    public static void main(String[] args) {
    	System.out.println(toUTF8String(null));
	}
}
